...
ActiveRecord::Schema.define(version: 20170624154254) do
  ...
  create_table "users_in_groups", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id", "group_id"], name: "index_users_in_groups_on_user_id_and_group_id", unique: true, using: :btree
